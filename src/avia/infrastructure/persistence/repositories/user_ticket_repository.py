...
from avia.infrastructure.persistence.db.models.models import PassengerOrm, UserTicketOrm
from avia.infrastructure.persistence.persist_base import PersistenceBase
from avia.infrastructure.persistence.repositories.mappers.user_ticket import (
    from_orm_to_user_ticket,
)


class UserTicketRepository(UserTicketRepositoryInterface, PersistenceBase):
