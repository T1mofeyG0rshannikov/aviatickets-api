...
from avia.application.dto.location import CityDTO, CountryDTO
from avia.application.dto.pdf_service import AdapterPdfField
from avia.application.dto.ticket import TicketFullInfoDTO, TicketSegmentFullInfoDTO
...
from avia.application.usecases.tickets.pdf.strategies.base import PdfTicketAdapter
