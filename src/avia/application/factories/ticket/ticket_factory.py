...
from avia.application.factories.ticket.ticket_segment_factory import (
    TicketSegmentFactory,
)
...
from avia.entities.tickets.ticket_entity.ticket_itinerary import TicketItinerary
