...
from avia.entities.user_ticket.user_ticket import Passenger, UserTicket
...
class PassengerFactory:
    ...
    def create(
        ...
        try:
            ...
            raise ExpiredInternationalPassportError(f"{first_name} {second_name}: истёк срок загран. паспорта")
