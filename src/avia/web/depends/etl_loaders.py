...
from avia.infrastructure.etl_parsers.regions_parser.adapter import RegionsLoaderAdapter
from avia.infrastructure.etl_parsers.regions_parser.parser import RegionsCsvParser
from avia.web.depends.annotations.annotations import LocationRepositoryAnnotation
from avia.web.depends.files_from_request import get_csv_file, get_txt_file
