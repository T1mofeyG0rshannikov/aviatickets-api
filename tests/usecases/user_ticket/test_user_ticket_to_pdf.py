        ...
        PdfFieldsAdapter(
            ...
            data_fields_list=[
                [
                    ...
                    AdapterPdfField(name="originDateShort", value="19-09-2025"),
                    AdapterPdfField(name="destinationDateShort", value="20-09-2025"),
                    AdapterPdfField(name="fromTo", value="MOSCOW, RUSSIA - MOSCOW, RUSSIA"),
                    AdapterPdfField(name="currency", value="RUB"),
                    AdapterPdfField(name="price", value="86,036.29"),
        ...
        PdfFieldsAdapter(
            ...
            data_fields_list=[
                [
                    ...
                    AdapterPdfField(name="originDate", value="FRIDAY 19 SEPTEMBER 2025"),
                    AdapterPdfField(name="originAirline", value="Qatar Airways"),
                    AdapterPdfField(name="originStatus", value="confirmed"),
                    AdapterPdfField(name="airbus", value="Boeing 787-9 pax"),
                ...
                [
                    ...
                    AdapterPdfField(name="Text-AUYa372fuH", value="SATURDAY 20 SEPTEMBER 2025"),
                    AdapterPdfField(name="originDate", value="SATURDAY 20 SEPTEMBER 2025"),
                    AdapterPdfField(name="originAirline", value="Qatar Airways"),
                    AdapterPdfField(name="originStatus", value="confirmed"),
                    AdapterPdfField(name="airbus", value="Airbus A350-900"),
                    AdapterPdfField(name="originClass", value="economy"),
                ...
                [
                    ...
                    AdapterPdfField(name="originDate", value="SATURDAY 27 SEPTEMBER 2025"),
                    AdapterPdfField(name="originAirline", value="Qatar Airways"),
                    AdapterPdfField(name="originStatus", value="confirmed"),
                    AdapterPdfField(name="airbus", value="Airbus A330-300"),
                    AdapterPdfField(name="originClass", value="economy"),
