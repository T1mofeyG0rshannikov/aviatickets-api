...
@pytest.mark.asyncio
async def test_login_user_not_found(login: Login):
...
@pytest.mark.asyncio
async def test_login_user_wrong_password(login: Login):
...
@pytest.mark.asyncio
async def test_login_admin_user(login: Login):
...
@pytest.mark.asyncio
async def test_login_permission_denied_admin_user(login: Login):
